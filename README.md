...
## О проекте
«Data Earthquake» — проект о землетрясениях, который предоставляет актуальную информацию и возможность анализа данных 
о землетрясениях по всему миру.
...
## Структура проекта
- [Data Governance](src/data_governance.md)
- [Создание проекта](src/project_create.md)
- [Заключение](src/conclusion.md)
